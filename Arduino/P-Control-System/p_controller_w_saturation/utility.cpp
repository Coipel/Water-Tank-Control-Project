...
// --------------------------------------------------------------------------Class for P controller-------------------------------------------------------------------------------------------
P_Controller::P_Controller(float P, float lowerbound_saturation, float upperbound_saturation) {
  P_Controller::P = P;
  P_Controller::lowerbound_saturation = lowerbound_saturation;
  P_Controller::upperbound_saturation = upperbound_saturation;  
}

float P_Controller::accuation(float error) {
  float desired_accuation = (P_Controller::P)*error;
  if (desired_accuation < P_Controller::lowerbound_saturation) {
    return P_Controller::lowerbound_saturation;
  }
  else if (desired_accuation > P_Controller::upperbound_saturation) {
    return P_Controller::upperbound_saturation;
  }
  return desired_accuation;
}
// -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
